...
@property (nonatomic, strong) NSString *coordinateTitle;
@property (nonatomic, strong) NSString *coordinateSubTitle;
...
@property (nonatomic, strong) ARMarker *coordinateMarker;	
